...
export const SystemSettings: React.FC<SettingsTabProps & { onReset: () => void }> = ({ settings, onSettingChange, onReset }) => {
    return (
        <>
            ...
            <div className="settings-section">
                ...
                <div className="settings-card">
                    <button className="settings-action-button danger" onClick={onReset}>
                        <RotateCcw size={18} />
                        <span>Reset App</span>
                    </button>
                </div>
