...
config :voicescribe_api, VoiceScribeAPIServer.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "CeCG86+pUfxU1B5YW9++uIhbufBPyPUh2jvU5hJfDNyrkZoaHZx24IedRav+lSt2",
  watchers: []
...
config :voicescribe_api, VoiceScribeAPIServer.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      # Router, Controllers
      ~r"lib/voicescribe_api_server/router\.ex$"E,
      ~r"lib/voicescribe_api_server/(controllers|channels)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :voicescribe_api, dev_routes: true
