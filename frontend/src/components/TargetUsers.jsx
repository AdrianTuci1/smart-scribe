                ...
                <div className="target-users-content">
                    ...
                    <div className="target-users-right">
                        ...
                        <div className="target-users-actions">
                            <button className="action-btn try-now">
                                <img src="/src/assets/orb-icon.svg" alt="Orb Icon" className="btn-icon" />
                                Try Now
                            </button>
                            <button className="action-btn download-macos">
                                <svg className="btn-icon apple-logo" viewBox="0 0 384 512" width="16" height="16" fill="currentColor">
