...
const Footer = ({ revealState = { showTop: false, showBottom: false, isVisible: false } }) => {
  ...
  return (
    <footer className={`footer ${revealState.isVisible ? 'is-visible' : ''}`}>
      <div className="footer-reveal-wrapper">
        <div className="footer-container">
          {/* Top Section */}
          <div className={`footer-top ${revealState.showTop ? 'show-top' : ''}`}>
            {/* Column 1: Tagline */}
            <div className="footer-tagline">
              <h3>Let your ideas take center stage.</h3>
            </div>
          ...
          <div className={`footer-content-bottom ${revealState.showBottom ? 'show-bottom' : ''}`}>
            {/* Legal Bar - Now Above Brand Text */}
            <div className="footer-legal-bar">
              <div className="footer-legal">
                <a href="/cookies">Cookies</a>
                <a href="/legal-notice">Legal Notice & Terms of Use</a>
                <a href="/privacy-policy">Privacy Policy</a>
              </div>
              <div className="footer-copyright">
                Copyright Smartscribe {currentYear}
              </div>
            </div>
