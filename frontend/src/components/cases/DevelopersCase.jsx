                ...
                <div className="developers-case__chat-bubble">
                    ...
                    <div className="developers-case__toolbar">
                        <div className="developers-case__toolbar-left">
                            {[
                                { text: 'B', className: 'developers-case__toolbar-button--bold' },
                                { text: 'I', className: 'developers-case__toolbar-button--italic' },
                                { text: 'S', className: 'developers-case__toolbar-button--strikethrough' },
                                {
                                    icon: (
                                ...
                                { text: '</>', className: 'developers-case__toolbar-button--code' }
                            ].map((btn, index) => (
                                <button key={index} className={`developers-case__toolbar-button ${btn.className || ''}`}>
                                    {btn.text ? <span>{btn.text}</span> : btn.icon}
                                </button>
                            ))}
                        </div>
